...
from agent.tools import history, news, portfolio, profile, report, risk, watchlist
...
_TOOLS = {
    ...
    watchlist.DEFINITION["name"]: watchlist.execute,
    profile.DEFINITION["name"]:   profile.execute,
}
